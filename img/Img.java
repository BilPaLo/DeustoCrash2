package practica2.utils.ventanas.ventanaJuego.img;

public class Img {
	/** Devuelve la URL de un recurso de imagen dado en este paquete
	 * Si no existe, muestra el volcado del error en la salida de error est�ndar
	...
	public static java.net.URL getURLRecurso( String nomRecImg ) {
		...
		try {
			...
			System.err.println( "Recurso incorrecto: " + nomRecImg + " no existe en paquete " + Img.class.getPackage() );
			// e.printStackTrace();
		}
		return recurso;
	}
