...
/** Clase de posici�n de tablero para juegos de tablero.
 * La representaci�n del tablero es por filas y columnas,
 * empezando las filas en 0 arriba e increment�ndose hacia abajo,
 * y las columnas en 0 a la izquierda, increment�ndose hacia la derecha.
 * @author eguiluz
 */
public class CoordTablero implements Serializable {
	 ...
	 * @return	Distancia en unidades de tablero  
	 */
